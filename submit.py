...
# 	### now select top 5 from error_list[2]i.e. chromosome into new_pop numpy array	
# 	for i in range(0,5):
# 		idx = error_list[i][0]
...
# 		print("idx:",i,"\t","error_val:",error_val,new_list)
...
min_weights=[ 9.86850781e+00  ,1.24031745e-01 ,-6.21194106e+00  ,4.93390314e-02,3.81084816e-02  ,8.13236610e-05 ,-6.01876916e-05 ,-1.25158557e-07,3.48409638e-08  ,4.16149250e-11 ,-6.73242018e-12]
# print(min_weights)
# print(team_id)
response=submit(team_id,min_weights)
print(response)